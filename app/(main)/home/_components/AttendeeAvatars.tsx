    ...
    <div className="flex -space-x-2">
      {attendeeList.slice(0, 4).map((attendee, index) => (
        <div key={index} className="relative group" title={attendee}>
          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border-2 border-background flex items-center justify-center text-white text-xs font-medium hover:scale-110 transition-transform">
